...
public class UpdateBookingTest extends BaseTest {
	...
	public void updateBookingTest() {
		...
		softassert.assertEquals(firstName, "Sumit", "Firstname does not match");

		String lastName = responseUpdate.jsonPath().getString("lastname");
		softassert.assertEquals(lastName, "Rawat", "Lastname does not match");

		String checkin = responseUpdate.jsonPath().getString("bookingdates.checkin");
		softassert.assertEquals(checkin, "2018-01-01", "Checkin does not match");
